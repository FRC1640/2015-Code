...
AddOutputFilter chunkFilter
		...
		<Item Name="NavX Code" Type="Folder">
			<Item Name="archived" Type="Folder">
				<Item Name="Doc" Type="Folder">
					<Item Name="cbool.png" Type="Document" URL="../NavX Code/archived/Doc/cbool.png"/>
					<Item Name="ccclst.png" Type="Document" URL="../NavX Code/archived/Doc/ccclst.png"/>
					<Item Name="cenum.png" Type="Document" URL="../NavX Code/archived/Doc/cenum.png"/>
					<Item Name="cerrcodeclst.png" Type="Document" URL="../NavX Code/archived/Doc/cerrcodeclst.png"/>
					<Item Name="ci32.png" Type="Document" URL="../NavX Code/archived/Doc/ci32.png"/>
					<Item Name="cstr.png" Type="Document" URL="../NavX Code/archived/Doc/cstr.png"/>
					<Item Name="cu8.png" Type="Document" URL="../NavX Code/archived/Doc/cu8.png"/>
					<Item Name="cvsrn.png" Type="Document" URL="../NavX Code/archived/Doc/cvsrn.png"/>
					<Item Name="ibool.png" Type="Document" URL="../NavX Code/archived/Doc/ibool.png"/>
					<Item Name="icclst.png" Type="Document" URL="../NavX Code/archived/Doc/icclst.png"/>
					<Item Name="idbl.png" Type="Document" URL="../NavX Code/archived/Doc/idbl.png"/>
					<Item Name="ienum.png" Type="Document" URL="../NavX Code/archived/Doc/ienum.png"/>
					<Item Name="ierrcodeclst.png" Type="Document" URL="../NavX Code/archived/Doc/ierrcodeclst.png"/>
					<Item Name="ii32.png" Type="Document" URL="../NavX Code/archived/Doc/ii32.png"/>
					<Item Name="index.html" Type="Document" URL="../NavX Code/archived/Doc/index.html"/>
					<Item Name="istr.png" Type="Document" URL="../NavX Code/archived/Doc/istr.png"/>
					<Item Name="iu8.png" Type="Document" URL="../NavX Code/archived/Doc/iu8.png"/>
					<Item Name="iu32.png" Type="Document" URL="../NavX Code/archived/Doc/iu32.png"/>
					<Item Name="ivsrn.png" Type="Document" URL="../NavX Code/archived/Doc/ivsrn.png"/>
					<Item Name="Nav6_lvlib_Close.html" Type="Document" URL="../NavX Code/archived/Doc/Nav6_lvlib_Close.html"/>
					<Item Name="Nav6_lvlib_Closec.png" Type="Document" URL="../NavX Code/archived/Doc/Nav6_lvlib_Closec.png"/>
					<Item Name="Nav6_lvlib_GetConnectionStatistics.html" Type="Document" URL="../NavX Code/archived/Doc/Nav6_lvlib_GetConnectionStatistics.html"/>
					<Item Name="Nav6_lvlib_GetConnectionStatisticsc.png" Type="Document" URL="../NavX Code/archived/Doc/Nav6_lvlib_GetConnectionStatisticsc.png"/>
					<Item Name="Nav6_lvlib_GetYawPitchRollCompass.html" Type="Document" URL="../NavX Code/archived/Doc/Nav6_lvlib_GetYawPitchRollCompass.html"/>
					<Item Name="Nav6_lvlib_GetYawPitchRollCompassc.png" Type="Document" URL="../NavX Code/archived/Doc/Nav6_lvlib_GetYawPitchRollCompassc.png"/>
					<Item Name="Nav6_lvlib_Open.html" Type="Document" URL="../NavX Code/archived/Doc/Nav6_lvlib_Open.html"/>
					<Item Name="Nav6_lvlib_Openc.png" Type="Document" URL="../NavX Code/archived/Doc/Nav6_lvlib_Openc.png"/>
					<Item Name="Nav6_lvlib_Refnum_Get.html" Type="Document" URL="../NavX Code/archived/Doc/Nav6_lvlib_Refnum_Get.html"/>
					<Item Name="Nav6_lvlib_Refnum_Getc.png" Type="Document" URL="../NavX Code/archived/Doc/Nav6_lvlib_Refnum_Getc.png"/>
					<Item Name="Nav6_lvlib_Refnum_Set.html" Type="Document" URL="../NavX Code/archived/Doc/Nav6_lvlib_Refnum_Set.html"/>
					<Item Name="Nav6_lvlib_Refnum_Setc.png" Type="Document" URL="../NavX Code/archived/Doc/Nav6_lvlib_Refnum_Setc.png"/>
					<Item Name="Nav6_lvlib_Run.html" Type="Document" URL="../NavX Code/archived/Doc/Nav6_lvlib_Run.html"/>
					<Item Name="Nav6_lvlib_Runc.png" Type="Document" URL="../NavX Code/archived/Doc/Nav6_lvlib_Runc.png"/>
					<Item Name="Nav6_lvlib_ZeroYaw.html" Type="Document" URL="../NavX Code/archived/Doc/Nav6_lvlib_ZeroYaw.html"/>
					<Item Name="Nav6_lvlib_ZeroYawc.png" Type="Document" URL="../NavX Code/archived/Doc/Nav6_lvlib_ZeroYawc.png"/>
					<Item Name="nav6_orientation.png" Type="Document" URL="../NavX Code/archived/Doc/nav6_orientation.png"/>
				</Item>
				<Item Name="Nav6Library" Type="Folder">
					<Item Name="Nav6.lvlib" Type="Library" URL="../NavX Code/archived/Nav6Library/Nav6.lvlib"/>
				</Item>
				<Item Name="Nav6 Example.aliases" Type="Document" URL="../NavX Code/archived/Nav6 Example.aliases"/>
				<Item Name="Nav6 Example.lvproj" Type="Document" URL="../NavX Code/archived/Nav6 Example.lvproj"/>
				<Item Name="Nav6 Example.vi" Type="VI" URL="../NavX Code/archived/Nav6 Example.vi"/>
				<Item Name="Readme.txt.txt" Type="Document" URL="../NavX Code/archived/Readme.txt.txt"/>
			</Item>
			<Item Name="navX-MXP Library" Type="Folder">
				...
				<Item Name="navX-MXP IMU.lvlib" Type="Library" URL="../NavX Code/navX-MXP Library/navX-MXP IMU.lvlib"/>
			</Item>
			<Item Name="LICENSE" Type="Document" URL="../NavX Code/LICENSE"/>
			<Item Name="navX Example (SERIAL).vi" Type="VI" URL="../NavX Code/navX Example (SERIAL).vi"/>
			<Item Name="navX Example (SPI - I2C).vi" Type="VI" URL="../NavX Code/navX Example (SPI - I2C).vi"/>
			<Item Name="navX-MXP.aliases" Type="Document" URL="../NavX Code/navX-MXP.aliases"/>
			<Item Name="navX-MXP.lvproj" Type="Document" URL="../NavX Code/navX-MXP.lvproj"/>
			<Item Name="README.md" Type="Document" URL="../NavX Code/README.md"/>
		</Item>
		...
		<Item Name="Team Code" Type="Folder">
			<Item Name="Auton" Type="Folder">
				...
				<Item Name="Motor to Joystick.vi" Type="VI" URL="../Motor to Joystick.vi"/>
				<Item Name="Read Script.vi" Type="VI" URL="../Read Script.vi"/>
				<Item Name="Unpack Script.vi" Type="VI" URL="../Unpack Script.vi"/>
			</Item>
			<Item Name="Begin" Type="Folder">
				<Item Name="Begin.vi" Type="VI" URL="../Begin.vi"/>
				<Item Name="Calibrate Drive.vi" Type="VI" URL="../Calibrate Drive.vi"/>
				<Item Name="Define Global Constants.vi" Type="VI" URL="../Define Global Constants.vi"/>
				...
				<Item Name="Set Refnums.vi" Type="VI" URL="../Set Refnums.vi"/>
				<Item Name="Setup Motors.vi" Type="VI" URL="../Setup Motors.vi"/>
			</Item>
			<Item Name="Other Stuff" Type="Folder">
				<Item Name="Disabled.vi" Type="VI" URL="../Disabled.vi"/>
				<Item Name="Feet To Tach.vi" Type="VI" URL="../Feet To Tach.vi"/>
			...
			<Item Name="Periodic Tasks" Type="Folder">
				<Item Name="Swerve" Type="Folder">
					<Item Name="Drive Core.vi" Type="VI" URL="../Drive Core.vi"/>
					<Item Name="Drive PID.vi" Type="VI" URL="../Drive PID.vi"/>
					<Item Name="Encoder Angles.vi" Type="VI" URL="../Encoder Angles.vi"/>
					<Item Name="Pivot Module.vi" Type="VI" URL="../Pivot Module.vi"/>
					<Item Name="Shortest Distance Absolute.vi" Type="VI" URL="../Shortest Distance Absolute.vi"/>
					<Item Name="Shortest Distance.vi" Type="VI" URL="../Shortest Distance.vi"/>
				</Item>
				<Item Name="joystick to degree.vi" Type="VI" URL="../joystick to degree.vi"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Ocelot.vi" Type="VI" URL="../Ocelot/Ocelot.vi"/>
			<Item Name="Read Config File.vi" Type="VI" URL="../Read Config File.vi"/>
			<Item Name="Sesnor_Degree_Finder.vi" Type="VI" URL="../Sesnor_Degree_Finder.vi"/>
			<Item Name="VarA.vi" Type="VI" URL="../Ocelot/VarA.vi"/>
			<Item Name="VarB.vi" Type="VI" URL="../Ocelot/VarB.vi"/>
			<Item Name="VarBLS.vi" Type="VI" URL="../Ocelot/VarBLS.vi"/>
			<Item Name="VarBRS.vi" Type="VI" URL="../Ocelot/VarBRS.vi"/>
			<Item Name="VarC.vi" Type="VI" URL="../Ocelot/VarC.vi"/>
			<Item Name="VarD.vi" Type="VI" URL="../Ocelot/VarD.vi"/>
			<Item Name="VarFLS.vi" Type="VI" URL="../Ocelot/VarFLS.vi"/>
			<Item Name="VarFRS.vi" Type="VI" URL="../Ocelot/VarFRS.vi"/>
			<Item Name="VarWD1.vi" Type="VI" URL="../Ocelot/VarWD1.vi"/>
			<Item Name="VarWD2.vi" Type="VI" URL="../Ocelot/VarWD2.vi"/>
			<Item Name="VarWD3.vi" Type="VI" URL="../Ocelot/VarWD3.vi"/>
			<Item Name="VarWD4.vi" Type="VI" URL="../Ocelot/VarWD4.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="My Real-Time Application" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				<Property Name="App_copyErrors" Type="Bool">true</Property>
				<Property Name="App_INI_aliasGUID" Type="Str">{77FD486C-2CC4-4181-AF94-5BC95157C957}</Property>
				<Property Name="App_INI_GUID" Type="Str">{65E59D00-73CE-4D0D-8650-53A56A0B6DC6}</Property>
				<Property Name="App_serverConfig.httpPort" Type="Int">8002</Property>
				<Property Name="Bld_autoIncrement" Type="Bool">true</Property>
				<Property Name="Bld_buildCacheID" Type="Str">{EACD80AF-523D-4D05-8ECB-C61F8DEDC6CB}</Property>
				...
				<Property Name="Bld_previewCacheID" Type="Str">{174BD36B-F8A5-4EAD-9CCF-4DDB6A341C52}</Property>
				...
				<Property Name="Source[0].itemID" Type="Str">{D328A6BD-4366-4BBF-B60C-FB87A7D849E0}</Property>
				...
				<Property Name="TgtF_targetfileGUID" Type="Str">{C81C01F9-BDEC-4C6C-B439-07C49E6B54C1}</Property>
